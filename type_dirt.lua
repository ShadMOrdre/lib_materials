...
local function register_dirts(readname)
	...
	if readname == "Dirt" then
		lib_materials.register_node(itemstr_dirt, "default:dirt", def1)
		lib_materials.register_node(
			itemstr_dirt .. "_with_coniferous_litter",
			"default:dirt_with_coniferous_litter", def2
		)
		lib_materials.register_node(
			itemstr_dirt .. "_with_rainforest_litter",
			"default:dirt_with_rainforest_litter", def3
		)
		lib_materials.register_node(
			itemstr_dirt .. "_with_snow", "default:dirt_with_snow", def4
		)
	else
		minetest.register_node(itemstr_dirt, def1)
		minetest.register_node(
			itemstr_dirt .. "_with_coniferous_litter", def2
		)
		minetest.register_node(
			itemstr_dirt .. "_with_rainforest_litter", def3
		)
		minetest.register_node(
			itemstr_dirt .. "_with_snow", def4
		)
	end
end
