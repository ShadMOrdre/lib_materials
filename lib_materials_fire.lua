...
minetest.register_node("lib_materials:fire_flame_basic", {
	drawtype = "firelike",
	tiles = {
		{
...
minetest.override_item("lib_materials:mineral_coal_block", {
	...
	on_ignite = function(pos, igniter)
		...
		if minetest.get_node(flame_pos).name == "air" then
			minetest.set_node(flame_pos, {name = "lib_materials:fire_flame_permanent"})
		end
	end,
})
...
if flame_sound then
	...
	function fire.update_player_sound(player)
		...
		local fpos, num = minetest.find_nodes_in_area(
			areamin,
			areamax,
			{"lib_materials:fire_flame_basic", "lib_materials:fire_flame_permanent"}
		)
		-- Total number of flames in radius
		local flames = (num["lib_materials:fire_flame_basic"] or 0) +
			(num["lib_materials:fire_flame_permanent"] or 0)
		-- Stop previous sound
